...
class McnIncomeRawLedgerControllerTest {
    ...
    private Map<String, Object> delivery(String deliveryId, String platformCode, String sourceEventId,
        ...
        return Map.of(
                ...
                "snapshotAt", "2026-09-12T08:32:00Z",
                ...
                "facts", List.of(Map.ofEntries(
                        ...
                        Map.entry("currencyCode", "XXX"),
                        Map.entry("amountUnit", platformCode + "_DIAMOND"),
                        Map.entry("factGranularity", "ACCOUNT_GUILD_DAY"),
                        Map.entry("businessDate", "2026-09-11"),
                        Map.entry("sourceTimezone", "Asia/Shanghai"),
                        Map.entry("periodStart", "2026-09-10T16:00:00Z"),
                        Map.entry("periodEnd", "2026-09-11T16:00:00Z"),
                        Map.entry("occurredAt", "2026-09-10T16:00:00Z"),
                        Map.entry("settledAt", "2026-09-12T08:30:00Z"),
                        Map.entry("sourceUpdatedAt", "2026-09-12T08:31:00Z"),
                        Map.entry("settlementBasis", "MCN_DAILY_FACT_FINALITY"),
